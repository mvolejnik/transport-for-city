...
public class QuartzInit implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent contextEvent) {
        ...
        app.ptd.server.scheduler.JobTimeParameters jobTimeParameteres = new JobTimeParameters(
                Duration.parse(context.getInitParameter(CONTEXT_PARAM_DELAY)),
                Duration.parse(context.getInitParameter(CONTEXT_PARAM_INTERVAL)),
                Duration.parse(context.getInitParameter(CONTEXT_PARAM_RND)));
        OPERATORS.putAll(initOperatorsResources(context.getInitParameter(CONTEXT_PARAM_OPERATOR)));
